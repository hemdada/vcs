...
@Service
public class HighscoredbQueryExecutorServiceImpl implements HighscoredbQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(HighscoredbQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("highscoredbWMQueryExecutor")
